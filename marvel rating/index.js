...
let json = `[{
    ...
    "name": "Супермен",
    "urlPhoto": "https://n1s1.hsmedia.ru/06/d3/73/06d37321618034ec5f2a65b09c8576e3/547x397_0xac120002_45567661540468871.jpg",
    "universe": "DC Comics",
    "alterEgo": "Кларк Кент",
    ...
    "urlPhoto": "https://n1s1.hsmedia.ru/7b/56/08/7b5608ec3df83d872fa1162fb9e32f28/547x397_0xac120002_1773711401540468871.jpg",
    ...
    "name": "Человек-паук",
    "urlPhoto": "https://n1s1.hsmedia.ru/37/39/74/373974effcc7ccd093d849e8fa062091/547x397_0xac120002_9548247751540468871.jpg",
    "universe": "Marvel Comics",
    ...
    "urlPhoto": "https://n1s1.hsmedia.ru/41/8f/05/418f050c767eeca8854b328914c7bccc/547x397_0xac120002_20106541761540468871.jpg",
    "universe": "Marvel Comics",
    ...
    "name": "Toр",
    "urlPhoto": "https://n1s1.hsmedia.ru/52/a3/e1/52a3e14a0c8f02715b763e7a20fe1c00/547x397_0xac120002_19311926741540468872.jpg",
    "universe": "Marvel Comics",
    ...
    "name": "Халк",
    "urlPhoto": "https://n1s1.hsmedia.ru/9a/28/e7/9a28e7b059594fc10387669ae4bd2f22/547x397_0xac120002_20162335021540468872.jpg",
    "universe": "Marvel Comics",
    ...
    "name": "Чудо-женщина",
    "urlPhoto": "https://n1s1.hsmedia.ru/87/ed/c5/87edc525d8813c7b2899e04a4e562fe9/547x397_0xac120002_6444132261540468872.jpg",
    "universe": "DC Comics",
    ...
    "name": "Черная вдова",
    "urlPhoto": "https://n1s1.hsmedia.ru/e0/2b/55/e02b55b147eeaff9b3fe6bdbb36ff9ea/547x397_0xac120002_744074131540468872.jpg",
    "universe": "Marvel Comics",
    ...
    "name": "Дэдпул",
    "urlPhoto": "https://n1s1.hsmedia.ru/34/93/39/3493392c94fc2ae0552ef9c7e87f2617/1034x543_0xac120002_2692921231540468872.jpg",
    "universe": "Marvel Comics",
...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    // const rts = {batman: 10, ironman: 9};

    for (let superhero of superheroes) {
        let showRt = "";

        //проверка пустой локал или нет
        if (localStorage.getItem('ratings') !== null) {
            ratings = JSON.parse(localStorage.getItem('ratings'));
            //console.log(ratings);
            if (ratings[superhero.name] !== undefined) {
                showRt = ratings[superhero.name];
            } 
            // else {
            //     showRt = "";
            // }
        ...
        <h2 class="js-hero-name">${superhero.name}</h2>
        <div><img src=${superhero.urlPhoto} alt="photo" width="50%"></div>
        <div><span class="subtitles">Вселенная: </span>${superhero.universe}</div>
        <div><span class="subtitles">Альтер эго: </span>${superhero.alterEgo}</div>
        <div><span class="subtitles">Род деятельности: </span>${superhero.occupation}</div>
        <div><span class="subtitles">Друзья: </span>${superhero.friends}</div>
        <div><span class="subtitles">Суперсилы: </span>${superhero.superpower}</div>
        <div><span class="subtitles">Подробнее: </span>${superhero.details}</div>
        <div class="subtitles">Текущий рейтинг: </div><span class="rating">${showRt}</span>
        <div class="subtitles">Введите рейтинг от 1 до 10: </div><input type="number" min=1 max=10 name="rating" class="js-input-rating">
        <button class="buttonItem">Выставить рейтинг</button>
        </div>`
    }
    document.getElementById("superheroesContainer").innerHTML = surepheroesContent;
});

const blockHero = document.querySelector('.main__all-heroes');

blockHero.addEventListener('click', (event) => {
    //тут будем видеть, по чему пришелся клик, проверка, что клик был по кнопке
    //console.log(event.target.classList.contains('buttonItem'));
    if (event.target.classList.contains('buttonItem')) {
        const parent = event.target.parentElement;
        //можно добавить проверку переменной
        const userRating = parent.querySelector('.js-input-rating').value;
        //сохраняем значение введенного инпута в поле сверху - текущий рейтинг
        parent.querySelector('.rating').textContent = userRating;
        const nameHero = parent.querySelector('.js-hero-name').textContent;
        ratings[nameHero] = userRating;
